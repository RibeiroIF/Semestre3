 ...
 * @author mpisching
 */
public class FXMLAPRelatorioPrincipalController implements Initializable {
    ...
    public void handleImprimir() throws JRException {
        URL url = getClass().getResource("/report/PrjSistemaLavacaoRelatorioPrincipal.jasper");
