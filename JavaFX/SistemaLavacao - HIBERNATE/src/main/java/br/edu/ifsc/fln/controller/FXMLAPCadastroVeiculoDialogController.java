...
public class FXMLAPCadastroVeiculoDialogController implements Initializable {
    ...
    private boolean validarEntradaDeDados() {
        String errorMessage = "";
        if (this.tfVeiculoPlaca.getText() == null || this.tfVeiculoPlaca.getText().length() == 0) {
            errorMessage += "Placa inválido.\n";
        }

        if (this.tfVeiculoObservacoes.getText() == null || this.tfVeiculoObservacoes.getText().length() == 0) {
