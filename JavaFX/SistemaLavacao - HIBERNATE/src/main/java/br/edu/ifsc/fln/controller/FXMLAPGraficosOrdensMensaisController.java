...
public class FXMLAPGraficosOrdensMensaisController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        //Map<Integer, ArrayList<Integer>> dados = ordemDAO.listarQuantidadeOrdemServicosPorMes();
        List<OrdensMensaisDTO> lista = ordemDAO.listarQuantidadeOrdensAnuais();
        // Agrupar por ano
        Map<Integer, XYChart.Series<String, Integer>> mapaSeries = new HashMap<>();
        for (OrdensMensaisDTO dto : lista) {
