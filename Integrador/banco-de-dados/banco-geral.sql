...
constraint fk_anuncio_usuario foreign key(id_vendedor) references usuario(id)
	on delete cascade
    on update cascade
) engine=innoDB;
...
constraint fk_avaliacao_usuario foreign key(id_comprador) references usuario(id)
	on delete cascade
    on update cascade
) engine=innoDB;
...
INSERT INTO usuario (nome, email, senha, data_cadastro, campus) VALUES
...
INSERT INTO administrador (id_usuario, ocupacao) VALUES
(1, 'Coordenador'),
(2, 'Técnico TI'),
(3, 'Bibliotecário'),
(4, 'Prefeito Campus'),
...
INSERT INTO aluno (id_usuario, curso) VALUES
(9, 'Engenharia Civil'),
...
('Livros', 'Livros acadêmicos e literatura em geral'),
('Eletrônicos', 'Celulares, notebooks e acessórios'),
('Móveis', 'Cadeiras, mesas e itens para dormitórios'),
('Vestuário', 'Roupas e acessórios acadêmicos'),
('Papelaria', 'Materiais de escritório e desenho'),
('Esportes', 'Equipamentos esportivos e lazer'),
('Eletrodomésticos', 'Cafeteiras, micro-ondas e frigobares'),
('Instrumentos', 'Instrumentos musicais e acessórios');

INSERT INTO anuncio (titulo, descricao, preco, status_anuncio, data_publicacao, data_expiracao, visualizacoes, denuncias, id_categoria, id_vendedor) VALUES
('Cálculo Vol 1 Stewart', 'Livro em bom estado, pouco usado.', 80.00, 'EM ABERTO', '2024-04-10', '2024-07-10', 45, 0, 1, 9),
('Mouse Gamer RGB', 'Mouse com 6 meses de uso, 3200 DPI.', 50.00, 'EM NEGOCIACAO', '2024-04-12', '2024-05-12', 120, 0, 2, 10),
('Escrivaninha Madeira', 'Mesa de estudos compacta para quarto.', 150.00, 'EM ABERTO', '2024-04-15', '2024-06-15', 30, 0, 3, 11),
('Jaleco Branco G', 'Jaleco de algodão, usado apenas 1 semestre.', 40.00, 'VENDIDO', '2024-03-01', '2024-04-01', 88, 0, 4, 12),
('Calculadora HP 12C', 'Calculadora financeira original.', 120.00, 'EM ABERTO', '2024-04-18', '2024-07-18', 60, 0, 2, 13),
('Vade Mecum 2023', 'Atualizado até dezembro de 2023.', 90.00, 'EM ABERTO', '2024-04-20', '2024-06-20', 150, 2, 1, 14),
('Violão Acústico', 'Acompanha capa e palheta.', 300.00, 'EM NEGOCIACAO', '2024-04-22', '2024-05-22', 200, 0, 8, 15),
('Monitor 24 Pol', 'Monitor Full HD em perfeito estado.', 450.00, 'EM ABERTO', '2024-04-25', '2024-07-25', 95, 0, 2, 16);
...
INSERT INTO feedback (descricao, data_feedback, id_usuario) VALUES
